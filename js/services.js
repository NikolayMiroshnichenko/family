	...
	},
	{
		...
		<div class="modal">
			<h3 class="modal-title">Дошлюбне консультування</h3>	
					...
					<p class="modal-descriptions__text"><span>6.</span> Внутрішньоматкова контрацепція (введення/видалення спіралей з подальшим консультативним супроводом лікаря).</p>
